            ...
            <div className="space-y-10">
              ...
              <div className="grid grid-cols-2 gap-12 pt-10 border-t border-border">
                <div className="space-y-3">
                  ...
                  <p className="text-2xl font-black text-dark tracking-tight">{project.client_name || "Enterprise Partner"}</p>
                </div>
                <div className="space-y-3">
                  <div className="flex items-center gap-2 text-primary font-black uppercase tracking-widest text-[10px]">
                    <Calendar size={12} /> Milestone Date
                  </div>
                  <p className="text-2xl font-black text-dark tracking-tight">{project.project_year || "2024"}</p>
                </div>
              </div>
