...
export default async function ServicePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const stats = service.detail_page_stats || [];
  const capabilities = service.detail_page_capabilities || service.features || [];
  const roadmap = service.detail_page_roadmap || [];
          ...
          <div className="max-w-5xl mx-auto text-center space-y-10">
            ...
            >
              ...
              <span className="text-primary font-black uppercase tracking-[0.2em] text-[10px]">
                {service.detail_page_badge || service.title}
              </span>
            </motion.div>
            ...
            >
              {service.detail_page_h1 || service.title}
            </motion.h1>
            ...
            >
              {service.detail_page_subtext || service.description}
            </motion.p>
