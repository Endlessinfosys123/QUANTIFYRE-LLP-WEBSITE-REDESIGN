...
export default function ProcessManagerPage() {
  ...
  if (loading) return <div className="p-8 text-[#A0A0B0] font-black uppercase tracking-widest animate-pulse">Scanning Process Framework...</div>;
    ...
    <div className="space-y-8 max-w-5xl mx-auto pb-20">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[#A0A0B0] font-medium mt-1 uppercase text-[10px] tracking-widest">Engineering Lifecycle Manager</p>
        </div>
              ...
              {steps.length === 0 && (
                <AdminTableRow>
                  <AdminTableCell className="text-center py-20" colSpan={5}>
                    <p className="text-[#3F3F46] font-black uppercase text-xs tracking-widest">No process steps registered</p>
                  </AdminTableCell>
                </AdminTableRow>
              )}
            </AdminTable>
    ...
    <AdminTableRow ref={setNodeRef} style={style}>
      ...
      <AdminTableCell>
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-[#0A0A0F] border border-[#1E1E2E] rounded-xl flex items-center justify-center text-xs font-black text-[#6C3FEF]">
            {step.step_number}
          </div>
          <p className="font-black text-white uppercase text-[12px] tracking-wider">{step.title}</p>
        </div>
      </AdminTableCell>
      <AdminTableCell>
        <p className="text-[10px] text-[#A0A0B0] font-bold line-clamp-1">{step.description}</p>
      </AdminTableCell>
      <AdminTableCell>
